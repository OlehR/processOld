...
//{
	...
	public class strings
	{
		...
		/// <pre>
		/// Example:
		/// strings.At("D", "Joe Doe");	//returns 5
		/// </pre>
		/// </summary>
		...
		/// <pre>
		/// Example:
		/// strings.At("o", "Joe Doe", 1);	//returns 2
		/// strings.At("o", "Joe Doe", 2);	//returns 6
		/// </pre>
		/// </summary>
		/// <param name="cSearchFor"> </param>
		/// <param name="cSearchIn"> </param>
		...
		/// <pre>
		/// Example:
		/// strings.AtC("d", "Joe Doe");	//returns 5
		/// </pre>
		/// </summary>
		/// <param name="cSearchFor"> </param>
		/// <param name="cSearchIn"> </param>
		...
		/// <pre>
		/// Example:
		/// strings.AtC("d", "Joe Doe", 1);	//returns 5
		/// strings.AtC("O", "Joe Doe", 2);	//returns 6
		/// </pre>
		/// </summary>
		/// <param name="cSearchFor"> </param>
		/// <param name="cSearchIn"> </param>
		...
		/// strings.GetWordCount(lcString);		//returns 6
		/// </pre>
		/// </summary>
		/// <param name="cString"> </param>
		public static long GetWordCount(string cString, char parChar=' ')
		{
			int i = 0 ;
		...
		/// Example:
		/// string lcString = "Joe Doe is a good man";
		/// strings.GetWordNumber(lcString, 5);		//returns "good"
		/// </pre>
		/// </summary>
		/// <param name="cString"> </param>
		/// <param name="nWordPosition"> </param>
		public static string GetWordNum(string cString, int nWordPosition,string parChar=" ")
		{
			if (cString==null)
				return null;
			int nBeginPos = strings.At(parChar,cString,nWordPosition - 1);
			if (nBeginPos ==-1)
				return "";
			int nEndPos = strings.At(parChar,cString, nWordPosition);
			
			if (nEndPos==-1) nEndPos=cString.Length+1;
			return strings.SubStr(cString, nBeginPos + 1, nEndPos -1 - nBeginPos);
		}

		public static string GetWordNum(string cString, int nWordPosition,char parChar)
		{
			return GetWordNum(cString, nWordPosition, parChar.ToString());
		}
...
/// 		<summary>
		...
		/// strings.Len(MyString);	//returns 8
		/// </pre>
		/// </summary>
		/// <param name="cExpression"> </param>
		...
		/// <pre>
		/// Example:
		/// strings.PadL("Joe Doe", 10, 'x');		//returns "xJoe Doexx"
		/// </pre>
		/// </summary>
		/// <param name="cExpression"> </param>
		/// <param name="nResultSize"> </param>
		...
		/// <pre>
		/// Example:
		/// strings.PadL("Joe Doe", 10, 'x');		//returns "xxxJoe Doe"
		/// 
		...
		/// <pre>
		/// Example:
		/// strings.RAt("o", "Joe Doe");	//returns 6
		/// </pre>
		/// </summary>
		/// <param name="cSearchFor"> </param>
		/// <param name="cSearchIn"> </param>
		...
		/// <pre>
		/// Example:
		/// strings.RAt("o", "Joe Doe", 1);	//returns 6
		/// strings.RAt("o", "Joe Doe", 2);	//returns 2
		/// </pre>
		/// </summary>
		/// <param name="cSearchFor"> </param>
		/// <param name="cSearchIn"> </param>
		...
		/// </summary>
		/// <example>
		/// strings.RTrim("VFPToolkitNET     "); //returns "VFPToolkitNET"
		/// </example>
		/// <param name="cExpression"> </param>
		...
		/// strings.StrExtract(cExpression, "o", "eJ", 1, 0);		//returns "eDo"
		/// </pre>
		/// </summary>
		...
		/// Example:
		/// string cExpression = "JoeDoeJoeDoe";
		/// strings.StrExtract(cExpression, "o");		//returns "eDoeJoeDoe"
		/// </pre>
		/// </summary>
		...
		/// Example:
		/// string cExpression = "JoeDoeJoeDoe";
		/// strings.StrExtract(cExpression, "o", "eJ");		//returns "eDo"
		/// </pre>
		/// </summary>
		/// <param name="cSearchExpression"> </param>
		/// <param name="cBeginDelim"> </param>
		...
		/// Example:
		/// string cExpression = "JoeDoeJoeDoe";
		/// strings.StrExtract(cExpression, "o", "eJ", 2);		//returns ""
		/// </pre>
		/// </summary>
		/// <param name="cSearchExpression"> </param>
		/// <param name="cBeginDelim"> </param>
		...
		/// strings.StrToFile(lcString, "c:\\My Folders\\MyFile.txt");
		/// </pre>
		/// </summary>
		/// <param name="cExpression"> </param>
		/// <param name="cFileName"> </param>
		...
		/// strings.Stuff(lcString, 5, 0, lcReplace);	//returns "Joe Foo Doe";
		/// strings.Stuff(lcString, 5, 3, lcReplace);	//returns "Joe Foo ";
		/// </pre>
		/// </summary>
		/// <param name="cExpression"> </param>
		...
		/// <pre>
		/// Example:
		/// strings.Upper("MyName");	//returns "MYNAME"
		/// </pre>
		/// </summary>
		/// <param name="cExpression"> </param>
		...
		/// <pre>
		/// Example:
		/// strings.AtLine("Is", "Is Life Beautiful? \r\n It sure is");	//returns 1
		/// </pre>
		/// </summary>
		...
		public static int AtLine(string tcSearchExpression, string tcExpressionSearched)
		{
			...
			try
			{
				nPosition = strings.At(tcSearchExpression, tcExpressionSearched);
				if (nPosition > 0)
				{
					lcString = strings.SubStr(tcExpressionSearched , 1, nPosition -1);
					nCount = strings.Occurs(@"\r", lcString) + 1;
				}
			}
			catch
			{
		...
		/// <pre>
		/// Example:
		/// strings.RAtLine("sure", "Is Life Beautiful? \r\n It sure is") 'returns 2
		/// </pre>
		/// </summary>
		/// <param name="tcSearchExpression"></param>
		/// <param name="tcExpressionSearched"></param>
		...
		public static int RAtLine(string tcSearchExpression, string tcExpressionSearched)
		{
			...
			try
			{
				nPosition = strings.RAt(tcSearchExpression, tcExpressionSearched);
				if (nPosition > 0)
				{
					lcString = strings.SubStr(tcExpressionSearched , 1, nPosition -1);
					nCount = strings.Occurs(@"\r", lcString) + 1;
		...
		/// <pre>
		/// Example:
		/// strings.AtCLine("Is Life Beautiful? \r\n It sure is", "Is");	//returns 1
		/// </pre>
		/// </summary>
		/// <param name="tcSearchExpression"></param>
		/// <param name="tcExpressionSearched"></param>
		...
		/// <pre>
		/// Example:
		/// int lnLines = strings.MemLines(lcMyLongString);
		/// </pre>
		/// </summary>
		...
		public static int MemLines(string tcString)
		{
			if(tcString.Trim().Length == 0)
				...
				return strings.Occurs("\\r", tcString) + 1;
		}
		...
		/// <pre>
		/// Example:
		/// string lcCity = strings.MLine(tcAddress, 2); // Not that you would want to do something like this but you could ;)
		/// </pre>
		/// </summary>
		/// <param name="tcString"></param>
